...
# python
sys.path.append('/data2/python_venv/2.7/djcmon/lib/python2.7/')
sys.path.append('/data2/python_venv/2.7/djcmon/lib/python2.7/site-packages/')
sys.path.append('/data2/python_venv/2.7/djcmon/lib/django_projects/')
sys.path.append('/data2/python_venv/2.7/djcmon/lib/django-djcmon/')
# django
